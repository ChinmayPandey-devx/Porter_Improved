  ...
  return (
    <PhoneFrame>
      <div className="flex-1 overflow-y-auto pb-20 no-scrollbar">
        <div className={cn("h-full", currentViewState.tab === 'home' ? 'block' : 'hidden')}>
          <HomeTab view={currentViewState.tab === 'home' ? currentViewState.view : 'home_main'} data={currentViewState.data} pushView={pushView} popView={popView} />
        </div>
        <div className={cn("h-full", currentViewState.tab === 'bookings' ? 'block' : 'hidden')}>
          <div className="p-4 flex items-center justify-center h-full text-gray-400">Bookings Content Placeholder</div>
        </div>
        <div className={cn("h-full", currentViewState.tab === 'business' ? 'block' : 'hidden')}>
          <BusinessTab />
        </div>
        <div className={cn("h-full", currentViewState.tab === 'profile' ? 'block' : 'hidden')}>
